...
import { createUserWithEmailAndPassword, signInWithEmailAndPassword, updateProfile } from "https://www.gstatic.com/firebasejs/12.5.0/firebase-auth.js";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    signUpBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            const userProperties = await setDoc(docRef, { email: email, name: name });
